...
public class PhoneCode  {
	...
	final Integer NUM = 6;
		...
		String appkey = "23643446";

		// 创建应用后系统会自动生成--前面图片中有说明
		String secret = "6f64b80cd859a965d536f3bc65f749a7";
		...
		// 签名名称
		req.setSmsFreeSignName("张友桥");

		// 短信模板的内容
		// String json = "{\"测试\":\"" + code + "\"}";
		String json = "{\"code\":\"" + code + "\",\"跳蚤市场\":\"个人网站建设测试\"}";
		...
		// 短信模板ID (验证码)模版
		req.setSmsTemplateCode("SMS_47940061");
